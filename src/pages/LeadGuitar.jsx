...
function LeadGuitar() {
    ...
    const fetchLeadNotes = async (trackId) => {
        try {
            const data = await apiRequest(`/guitar-tracks/${trackId}/notes`, null, token, "GET")
            ...
            <div className='lead-header'>
                ...
                <button
                    ...
                    onClick={async () => {
                        ...
                        await Tone.start()
                        const seq = playGuitarTrack(makeGuitarNotesArray(), bpm, 0, false, "guitar")
                        seqRef.current = seq
                    }}
                >Play All</button>
                ...
                <button
                    ...
                    onClick={async () => {
                        ...
                        await Tone.start()
                        const seq = playGuitarTrack(makeGuitarNotesArray(), bpm, 0, true, "guitar")
                        seqRef.current = seq
                    }}
